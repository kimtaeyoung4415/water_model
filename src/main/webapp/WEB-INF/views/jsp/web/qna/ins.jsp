		...
		<div class="sub-container">
			<div class="application_modal">
				...
				<div class="input_wrapper">
					...
					<input type="text" id="Q_NAME" name="C_NAME" placeholder="홍길동" required="required">
				</div>
				<div class="input_wrapper">
					<label for="MOBILE">연락처</label>
					<input type="text" id="Q_MOBILE" name="MOBILE" placeholder="01012345678 '-' 없이 입력"  maxlength="11" required="required">
				</div>
				<div class="input_wrapper">
					<label for="EMAIL">이메일</label>
					<input type="text" id="Q_EMAIL" name="EMAIL" placeholder="example@mail.com" required="required">
				</div>
				<div class="input_wrapper">
					<label for="C_TITLE">제목</label>
					<input type="text" id="Q_TITLE" name="C_TITLE" placeholder="문의 제목" maxlength="50" required="required">
				</div>
				<div class="input_wrapper">
