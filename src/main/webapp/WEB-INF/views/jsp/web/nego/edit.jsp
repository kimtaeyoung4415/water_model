		...
		<div class="sub-container">
			<div class="application_modal">
				...
				<div class="input_wrapper">
					...
					<input type="text" id="MOBILE" name="MOBILE" placeholder="01012345678 '-' 없이 입력"  maxlength="11" required="required" value="${dtl.MOBILE }">
				</div>
				<div class="input_wrapper">
					<label for="EMAIL">이메일</label>
					<input type="text" id="EMAIL" name="EMAIL" placeholder="example@mail.com" required="required" value="${dtl.EMAIL }">
				</div>
				<div class="input_wrapper">
				...
				<div class="input_wrapper">
					...
					<textarea id="C_CONT" name="C_CONTENT" rows="5" placeholder="문의 내용" required="required">${dtl.C_CONTENT }</textarea>
				</div>
				<div class="input_wrapper">
